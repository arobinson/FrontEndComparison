...
The chart below normalizes all metrics as percentages relative to the best performer in each category (100% = winner). Lower is better.

![diagram](./charts-10.svg)

*Normalized average across: FCP, Filter, Clear, Navigate Detail, Navigate Back, Pagination, Detail Nav, Bundle Size*
